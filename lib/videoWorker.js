...
export const getVideoQueue = () => {
  ...
  if (!videoQueue) {
    ...
    // Reuse the existing robust Redis connection if possible
    // Note: BullMQ usually requires a specific connection type/config, but passing the ioredis instance handles it.
