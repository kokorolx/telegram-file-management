...
/**
 * Encrypts sensitive system data (like per-user API tokens)
 * @param {string} text
 * @returns {string} Combined format: iv:authTag:encryptedData
 */
export function encryptSystemData(text) {
  if (!text) return null;
 ...
 * @param {string} encryptedText - iv:authTag:encryptedData
 * @returns {string} plaintext
 */
export function decryptSystemData(encryptedText) {
